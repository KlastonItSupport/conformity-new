...
const RolesPage = () => {
  ...
  useEffect(() => {
    const updateIcons = () => {
      ...
      const trainingIcon = checkPermissionForAction("companies", "canEdit")
        ? {
  ...
  return (
    <>
      ...
      <DeleteModal
        title={t("Excluir Cargo")}
        subtitle={t("Tem certeza de que deseja excluir este Cargo?")}
        isOpen={isDeleteModalOpen}
        onClose={onDeleteModalClose}
        onConfirm={async () => {
          setIsLoading(true);
      ...
      />
      <DeleteModal
        title={t("Excluir Cargos")}
        subtitle={t("Tem certeza de que deseja excluir estes Cargos?")}
        isOpen={isDeleteMultipleModalOpen}
        onClose={onDeleteMultipleModalClose}
        onConfirm={async () => {
